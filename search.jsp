...
<script type="text/javascript">
  ...
  function info()
  {
    ...
    window.location.href="search.jsp?value="+search;
  }
...
<body>
 ...
 <div class="header" id="myHeader" style="display: inline-flex;">
  <div>
  <form class="form-inline md-form form-sm" style="margin-left: 200px; margin-top: 20px; width: 500px;">
   
  <input class="form-control form-control-sm" type="text" name="search" id="vaishali"  onkeypress="javascript:doit_onkeypress(event);"
   placeholder="Search" style="width: 50%;" />&nbsp;
   &nbsp;&nbsp;&nbsp; <button class="button" id="sure" type="button" onclick="info();">Submit</button>
</form>
  </div>

<div>
  <button class="button"  value="Delete" onclick="if (confirm('Are you sure you want to delete?')) form.action='deletion.jsp'; else return false"  style=" margin-left: 300px; margin-top: 20px;">Delete</button>
    </div>
