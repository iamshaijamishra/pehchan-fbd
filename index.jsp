...
.dropdown-content a:hover {background-color: #818181;}
...
<!--<nav class="navbar navbar-light bg-light">
  ...
  <div class="dropdown">
  	  <a style="color: #818181;">Dropdown</a>
...
<div class="container-fluid" style="overflow: auto;">
  ...
  <table class="table table-hover">
    ...
    try
    {
        ...
        ResultSet rs=st.executeQuery("select id,image_name,title from news;");
    %>
    ...
    <%while(rs.next())
      ...
      <tr style="text-align: right;" valign="middle">
        ...
        <a href="display1.jsp?id=<%=rs.getInt("id")%>"> <%out.print(rs.getString("title"));%></a></div>
      </tr>
      <br>
      <%
    }%>
...
<footer class="page-footer font-small blue pt-4" >
  ...
  <div class="container-fluid text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mt-md-0 mt-3">
        ...
        <!-- Copyright -->
  <div class="footer-copyright text-md-left py-3"> © 2018 Copyright:
  ...
  <!-- Copyright -->
      ...
      <div class="col">
		...
		<div class="zoom">	
  <a class="navbar-brand" href="https://www.facebook.com/" style="color: #0033CC;">
    <img src="images/facebook.svg" width="30" height="30" alt="">
          ...
          <li>
            <nav class="text-muted">
            	<div class="zoom">
  <a class="navbar-brand" href="https://twitter.com/login" style="color: #0033CC">
    <img src="images/twitter.svg" width="30" height="30" alt="">
          ...
          <nav class="text-muted">
          	<div class="zoom">
            <a class="navbar-brand" href="https://www.google.com/gmail/" style="color: #0033CC">
